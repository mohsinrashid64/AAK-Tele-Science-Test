...
/* harmony export */   "VictoryBrushLine": function() { return /* binding */ VictoryBrushLine; }
/* harmony export */ });
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-primitives/border.js");
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/selection.js");
...
const getScale = props => {
  ...
  const fallbackScale = victory_core__WEBPACK_IMPORTED_MODULE_4__.getBaseScale(props, dimension);
  const range = victory_core__WEBPACK_IMPORTED_MODULE_5__.getRange(props, dimension);
  const domain = victory_core__WEBPACK_IMPORTED_MODULE_6__.getDomainFromProps(props, dimension) || [0, 1];
...
const withinBound = (value, bound) => {
  return value >= victory_core__WEBPACK_IMPORTED_MODULE_7__.getMinValue(bound) && value <= victory_core__WEBPACK_IMPORTED_MODULE_7__.getMaxValue(bound);
};
const getBrushDomain = (brushDomain, fullDomain) => {
  if (brushDomain) {
    const brushMin = victory_core__WEBPACK_IMPORTED_MODULE_7__.getMinValue(brushDomain);
    const brushMax = victory_core__WEBPACK_IMPORTED_MODULE_7__.getMaxValue(brushDomain);
    const domainMin = victory_core__WEBPACK_IMPORTED_MODULE_7__.getMinValue(fullDomain);
    const domainMax = victory_core__WEBPACK_IMPORTED_MODULE_7__.getMaxValue(fullDomain);
...
class VictoryBrushLine extends (react__WEBPACK_IMPORTED_MODULE_2___default().Component) {
  static defaultProps = {
    allowDrag: true,
    allowDraw: true,
    allowResize: true,
    brushAreaComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__.Border, null),
    brushComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__.Border, null),
    groupComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("g", null),
    handleComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__.Border, null),
    handleWidth: 10,
    lineComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_9__.LineSegment, null),
    width: 10
  };
    ...
    return props.disable ? undefined : [{
      ...
      eventHandlers: {
        onMouseEnter: (evt, targetProps) => {
          ...
          const parentSVG = targetProps.parentSVG || victory_core__WEBPACK_IMPORTED_MODULE_10__.getParentSVG(evt);
          const position = victory_core__WEBPACK_IMPORTED_MODULE_10__.getSVGEventCoordinates(evt, parentSVG)[dimension];
          ...
          const activeBrushes = {
            ...
            brush: withinBound(position, range) && !react_fast_compare__WEBPACK_IMPORTED_MODULE_3___default()(fullDomain, currentDomain),
        ...
        onMouseDown: (evt, targetProps) => {
          ...
          } else if (withinBound(position, range) && !react_fast_compare__WEBPACK_IMPORTED_MODULE_3___default()(fullDomain, currentDomain)) {
        ...
        onMouseMove: (evt, targetProps) => {
          ...
          const activeBrushes = {
            brushArea: !targetProps.brushDomain,
            brush: withinBound(position, initialRange) && !react_fast_compare__WEBPACK_IMPORTED_MODULE_3___default()(fullDomain, domain),
            minHandle: activeHandle === "min" || activeHandle === "both",
          ...
          if (allowDrag && isPanning) {
            ...
            if (victory_core__WEBPACK_IMPORTED_MODULE_5__.isFunction(onBrushDomainChange)) {
        ...
        onMouseUp: (evt, targetProps) => {
          ...
          if (allowResize && victory_core__WEBPACK_IMPORTED_MODULE_5__.isFunction(onBrushDomainChange)) {
            onBrushDomainChange(brushDomain, lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, mutatedProps, targetProps));
          }
          return [{
            mutation: () => mutatedProps
          }];
  ...
  renderHandles(props) {
    ...
    const minDatum = Object.assign({
      handleValue: victory_core__WEBPACK_IMPORTED_MODULE_7__.getMinValue(brushDomain)
    }, datum);
    const maxDatum = Object.assign({
      handleValue: victory_core__WEBPACK_IMPORTED_MODULE_7__.getMaxValue(brushDomain)
    }, datum);
    const minHandleProps = Object.assign({
      key: `${id}-min`,
      style: victory_core__WEBPACK_IMPORTED_MODULE_5__.evaluateStyle(style, {
        datum: minDatum,
    ...
    return [/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().cloneElement(handleComponent, minHandleProps), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().cloneElement(handleComponent, maxHandleProps)];
  }
  renderBrush(props) {
    const {
      brushComponent,
    ...
    const style = victory_core__WEBPACK_IMPORTED_MODULE_5__.evaluateStyle(baseStyle, {
      datum,
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().cloneElement(brushComponent, brushProps);
  }
  renderBrushArea(props) {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().cloneElement(brushAreaComponent, brushAreaProps);
  }
  renderLine(props) {
    const filteredProps = lodash_pick__WEBPACK_IMPORTED_MODULE_0___default()(props, ["x1", "x2", "y1", "y2", "datum", "scale", "active", "style"]);
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().cloneElement(props.lineComponent, filteredProps);
  }
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("g", this.props.events, this.renderLine(this.props), this.renderBrushArea(this.props), this.renderBrush(this.props), this.renderHandles(this.props));
  }
}
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _victory_util_helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../victory-util/helpers */ "../../victory-core/es/victory-util/helpers.js");
/* harmony import */ var _line__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./line */ "../../victory-core/es/victory-primitives/line.js");
...
const defaultProps = {
  lineComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_line__WEBPACK_IMPORTED_MODULE_2__.Line, null),
  role: "presentation",
  shapeRendering: "auto"
};
const LineSegment = initialProps => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(props.lineComponent, {
    ...props.events,
    "aria-label": props.ariaLabel,
    style: props.style,
    desc: props.desc,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VictoryBrushLine": function() { return /* reexport safe */ _victory_brush_line__WEBPACK_IMPORTED_MODULE_0__.VictoryBrushLine; }
/* harmony export */ });
