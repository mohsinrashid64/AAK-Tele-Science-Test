...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-primitives/line.js");
...
const evaluateProps = props => {
   ...
   * `tabIndex`
   */
  const ariaLabel = victory_core__WEBPACK_IMPORTED_MODULE_1__.evaluateProp(props.ariaLabel, props);
  const id = victory_core__WEBPACK_IMPORTED_MODULE_1__.evaluateProp(props.id, props);
  const style = victory_core__WEBPACK_IMPORTED_MODULE_1__.evaluateStyle(Object.assign({
    stroke: "black"
  }, props.style), props);
  const tabIndex = victory_core__WEBPACK_IMPORTED_MODULE_1__.evaluateProp(props.tabIndex, props);
...
const defaultProps = {
  ...
  lineComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_2__.Line, null),
  role: "presentation",
  shapeRendering: "auto"
};
const ErrorBar = initialProps => {
  ...
  const userProps = victory_core__WEBPACK_IMPORTED_MODULE_3__.getSafeUserProps(props);
  const {
    tabIndex,
    ariaLabel
  } = props;
...
const getData = props => {
  ...
  const generatedData = props.errorX || props.errorY ? victory_core__WEBPACK_IMPORTED_MODULE_2__.generateData(props) : [];
  return victory_core__WEBPACK_IMPORTED_MODULE_2__.formatData(generatedData, props, accessorTypes);
};
...
const formatDataFromDomain = (datum, domain) => {
  const minDomainX = victory_core__WEBPACK_IMPORTED_MODULE_4__.getMinValue(domain.x);
  const maxDomainX = victory_core__WEBPACK_IMPORTED_MODULE_4__.getMaxValue(domain.x);
  const minDomainY = victory_core__WEBPACK_IMPORTED_MODULE_4__.getMinValue(domain.y);
  const maxDomainY = victory_core__WEBPACK_IMPORTED_MODULE_4__.getMaxValue(domain.y);
  let {
    _x,
    _y
  } = datum;
...
const getCalculatedValues = props => {
  const defaultStyles = victory_core__WEBPACK_IMPORTED_MODULE_5__.getDefaultStyles(props, "errorbar");
  const style = victory_core__WEBPACK_IMPORTED_MODULE_5__.getStyles(props.style, defaultStyles) || {};
  const data = getData(props);
  const range = {
    x: victory_core__WEBPACK_IMPORTED_MODULE_5__.getRange(props, "x"),
    y: victory_core__WEBPACK_IMPORTED_MODULE_5__.getRange(props, "y")
  };
  const domain = {
    x: getDomain(props, "x"),
    y: getDomain(props, "y")
  ...
  const origin = props.polar ? props.origin || victory_core__WEBPACK_IMPORTED_MODULE_5__.getPolarOrigin(props) : undefined;
  return {
    domain,
    data,
    scale,
...
const getLabelProps = (dataProps, text, style) => {
  ...
  if (!victory_core__WEBPACK_IMPORTED_MODULE_5__.isTooltip(labelComponent)) {
    return labelProps;
  }
  const tooltipTheme = theme && theme.tooltip || {};
  return lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, labelProps, victory_core__WEBPACK_IMPORTED_MODULE_5__.omit(tooltipTheme, ["style"]));
};
const getBaseProps = (initialProps, fallbackProps) => {
  const modifiedProps = victory_core__WEBPACK_IMPORTED_MODULE_5__.modifyProps(initialProps, fallbackProps, "errorbar");
  ...
  return data.reduce((childProps, datum, index) => {
    const eventKey = !victory_core__WEBPACK_IMPORTED_MODULE_5__.isNil(datum.eventKey) ? datum.eventKey : index;
    const {
      x,
      y
    } = victory_core__WEBPACK_IMPORTED_MODULE_5__.scalePoint(lodash_assign__WEBPACK_IMPORTED_MODULE_0___default()({}, props, {
      scale
    }), datum);
    ...
    const text = victory_core__WEBPACK_IMPORTED_MODULE_7__.getText(props, datum, index);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VictoryErrorBar": function() { return /* binding */ VictoryErrorBar; }
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _error_bar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./error-bar */ "./error-bar.tsx");
/* harmony import */ var _helper_methods__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./helper-methods */ "./helper-methods.tsx");
...
class VictoryErrorBarBase extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  static defaultProps = {
    ...
    data: defaultData,
    dataComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_error_bar__WEBPACK_IMPORTED_MODULE_3__.ErrorBar, null),
  ...
  static getDomain(props, axis) {
    return (0,_helper_methods__WEBPACK_IMPORTED_MODULE_6__.getDomain)(props, axis);
  }
  static getData(props) {
    return (0,_helper_methods__WEBPACK_IMPORTED_MODULE_6__.getData)(props);
  }
...
const VictoryErrorBar = (0,victory_core__WEBPACK_IMPORTED_MODULE_9__.addEvents)(VictoryErrorBarBase);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ErrorBar": function() { return /* reexport safe */ _error_bar__WEBPACK_IMPORTED_MODULE_1__.ErrorBar; },
/* harmony export */   "VictoryErrorBar": function() { return /* reexport safe */ _victory_errorbar__WEBPACK_IMPORTED_MODULE_0__.VictoryErrorBar; }
/* harmony export */ });
