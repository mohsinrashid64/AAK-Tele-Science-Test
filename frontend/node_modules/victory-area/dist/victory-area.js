...
/* harmony import */ var victory_vendor_d3_shape__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! victory-vendor/d3-shape */ "../../victory-vendor/es/d3-shape.js");
...
const getCartesianArea = props => {
  ...
  const interpolationFunction = victory_core__WEBPACK_IMPORTED_MODULE_2__.getInterpolationFunction(props);
  return horizontal ? victory_vendor_d3_shape__WEBPACK_IMPORTED_MODULE_1__.area().defined(defined).curve(interpolationFunction).x0(getY0Accessor(scale)).x1(getYAccessor(scale)).y(getXAccessor(scale)) : victory_vendor_d3_shape__WEBPACK_IMPORTED_MODULE_1__.area().defined(defined).curve(interpolationFunction).x(getXAccessor(scale)).y1(getYAccessor(scale)).y0(getY0Accessor(scale));
};
const getAreaFunction = props => {
  ...
  const interpolationFunction = victory_core__WEBPACK_IMPORTED_MODULE_2__.getInterpolationFunction(props);
  return polar ? victory_vendor_d3_shape__WEBPACK_IMPORTED_MODULE_1__.radialArea().defined(defined).curve(interpolationFunction).angle(getAngleAccessor(scale)).outerRadius(getYAccessor(scale)).innerRadius(getY0Accessor(scale)) : getCartesianArea(props);
};
const evaluateProps = props => {
  ...
  const style = victory_core__WEBPACK_IMPORTED_MODULE_3__.evaluateStyle(Object.assign({
    fill: "black"
  }, props.style), props);
...
const Area = initialProps => {
  ...
  const lineFunction = renderLine && victory_core__WEBPACK_IMPORTED_MODULE_2__.getLineFunction(props);
