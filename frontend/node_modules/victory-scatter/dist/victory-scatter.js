...
/* harmony export */   "getBubbleSize": function() { return /* binding */ getBubbleSize; },
/* harmony export */   "getSize": function() { return /* binding */ getSize; },
/* harmony export */   "getSymbol": function() { return /* binding */ getSymbol; }
/* harmony export */ });
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/helpers.js");
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/domain.js");
...
const getBubbleSize = (datum, props) => {
  ...
  const getMaxRadius = () => {
    const minPadding = Math.min(...Object.values(victory_core__WEBPACK_IMPORTED_MODULE_0__.getPadding(props)));
...
const getCalculatedValues = props => {
  const defaultStyles = victory_core__WEBPACK_IMPORTED_MODULE_0__.getDefaultStyles(props, "scatter");
  const style = victory_core__WEBPACK_IMPORTED_MODULE_0__.getStyles(props.style, defaultStyles);
  const range = {
    x: victory_core__WEBPACK_IMPORTED_MODULE_0__.getRange(props, "x"),
    y: victory_core__WEBPACK_IMPORTED_MODULE_0__.getRange(props, "y")
  };
  const domain = {
    x: victory_core__WEBPACK_IMPORTED_MODULE_1__.getDomain(props, "x"),
    y: victory_core__WEBPACK_IMPORTED_MODULE_1__.getDomain(props, "y")
  };
  const scale = {
    x: victory_core__WEBPACK_IMPORTED_MODULE_2__.getBaseScale(props, "x").domain(domain.x).range(props.horizontal ? range.y : range.x),
    y: victory_core__WEBPACK_IMPORTED_MODULE_2__.getBaseScale(props, "y").domain(domain.y).range(props.horizontal ? range.x : range.y)
  };
  const origin = props.polar ? props.origin || victory_core__WEBPACK_IMPORTED_MODULE_0__.getPolarOrigin(props) : undefined;
  const z = props.bubbleProperty || "z";
  let data = victory_core__WEBPACK_IMPORTED_MODULE_3__.getData(props);
  data = victory_core__WEBPACK_IMPORTED_MODULE_3__.formatDataFromDomain(data, domain);
  return {
    domain,
    data,
    scale,
...
const getBaseProps = (initialProps, fallbackProps) => {
  const modifiedProps = victory_core__WEBPACK_IMPORTED_MODULE_0__.modifyProps(initialProps, fallbackProps, "scatter");
  ...
  return data.reduce((childProps, datum, index) => {
    const eventKey = !victory_core__WEBPACK_IMPORTED_MODULE_0__.isNil(datum.eventKey) ? datum.eventKey : index;
    const {
      x,
      y
    } = victory_core__WEBPACK_IMPORTED_MODULE_0__.scalePoint(props, datum);
    const dataProps = {
      x,
      y,
      datum,
    ...
    if (text !== undefined && text !== null || labels && (events || sharedEvents)) {
      childProps[eventKey].labels = victory_core__WEBPACK_IMPORTED_MODULE_4__.getProps(props, index);
    }
    return childProps;
  }, initialChildProps);
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VictoryScatter": function() { return /* binding */ VictoryScatter; }
/* harmony export */ });
 ...
 */
class VictoryScatterBase extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
...
const VictoryScatter = (0,victory_core__WEBPACK_IMPORTED_MODULE_11__.addEvents)(VictoryScatterBase);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VictoryScatter": function() { return /* reexport safe */ _victory_scatter__WEBPACK_IMPORTED_MODULE_0__.VictoryScatter; }
/* harmony export */ });
