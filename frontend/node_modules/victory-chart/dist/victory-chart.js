...
const VictoryChartImpl = initialProps => {
  const propsWithDefaults = react__WEBPACK_IMPORTED_MODULE_2___default().useMemo(() => ({
    ...defaultProps,
    ...initialProps
  }), [initialProps]);
  const role = "chart";
...
/* harmony import */ var _path__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./path */ "../../victory-core/es/victory-primitives/path.js");
...
const getArcPath = props => {
  ...
  const x1 = cx + r * Math.cos(_victory_util_helpers__WEBPACK_IMPORTED_MODULE_1__.degreesToRadians(startAngle));
  const y1 = cy - r * Math.sin(_victory_util_helpers__WEBPACK_IMPORTED_MODULE_1__.degreesToRadians(startAngle));
  const x2 = cx + r * Math.cos(_victory_util_helpers__WEBPACK_IMPORTED_MODULE_1__.degreesToRadians(halfAngle));
  const y2 = cy - r * Math.sin(_victory_util_helpers__WEBPACK_IMPORTED_MODULE_1__.degreesToRadians(halfAngle));
  const x3 = cx + r * Math.cos(_victory_util_helpers__WEBPACK_IMPORTED_MODULE_1__.degreesToRadians(endAngle));
  const y3 = cy - r * Math.sin(_victory_util_helpers__WEBPACK_IMPORTED_MODULE_1__.degreesToRadians(endAngle));
...
const defaultProps = {
  pathComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_path__WEBPACK_IMPORTED_MODULE_2__.Path, null),
  role: "presentation",
  shapeRendering: "auto"
};
...
/* harmony import */ var _circle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./circle */ "../../victory-core/es/victory-primitives/circle.js");
...
const defaultProps = {
  circleComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_circle__WEBPACK_IMPORTED_MODULE_2__.Circle, null),
  rectComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_rect__WEBPACK_IMPORTED_MODULE_3__.Rect, null),
  role: "presentation",
  shapeRendering: "auto"
};
const Background = initialProps => {
  ...
  return props.polar ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(props.circleComponent, {
    ...props.events,
    style: props.style,
    role: props.role,
    shapeRendering: props.shapeRendering,
    ...
    r: props.height,
    className: props.className
  }) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(props.rectComponent, {
    ...props.events,
    style: props.style,
    role: props.role,
    shapeRendering: props.shapeRendering,
