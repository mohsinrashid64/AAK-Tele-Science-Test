...
/* harmony export */   "Candle": function() { return /* binding */ Candle; }
/* harmony export */ });
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-primitives/line.js");
...
const getCandleWidth = (candleWidth, props) => {
  ...
  if (candleWidth) {
    return victory_core__WEBPACK_IMPORTED_MODULE_2__.isFunction(candleWidth) ? victory_core__WEBPACK_IMPORTED_MODULE_2__.evaluateProp(candleWidth, props) : candleWidth;
  } else if (style.width) {
    return style.width;
  }
  return candleWidth;
...
const getCandleProps = (props, style) => {
  ...
  return {
    key: `${id}-candle`,
    style: victory_core__WEBPACK_IMPORTED_MODULE_2__.omit(style, ["width"]),
...
const evaluateProps = props => {
  ...
  const desc = victory_core__WEBPACK_IMPORTED_MODULE_2__.evaluateProp(props.desc, props);
...
const defaultProps = {
  ...
  lineComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_3__.Line, null),
  rectComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_4__.Rect, null),
  role: "presentation",
  shapeRendering: "auto"
};
const Candle = props => {
  ...
  const wickStyle = lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().cloneElement(groupComponent, {}, [/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().cloneElement(rectComponent, candleProps), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().cloneElement(lineComponent, highWickProps), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().cloneElement(lineComponent, lowWickProps)]);
};
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/data.js");
...
const getData = props => {
  ...
  return victory_core__WEBPACK_IMPORTED_MODULE_2__.formatData(props.data, props, accessorTypes);
};
...
const getDomainFromData = (props, axis) => {
  const minDomain = victory_core__WEBPACK_IMPORTED_MODULE_3__.getMinFromProps(props, axis);
  const maxDomain = victory_core__WEBPACK_IMPORTED_MODULE_3__.getMaxFromProps(props, axis);
  const dataset = getData(props);
  if (dataset.length < 1) {
    return minDomain !== undefined && maxDomain !== undefined ? victory_core__WEBPACK_IMPORTED_MODULE_3__.getDomainFromMinMax(minDomain, maxDomain) : undefined;
  }
  ...
  return victory_core__WEBPACK_IMPORTED_MODULE_3__.getDomainFromMinMax(min, max);
};
const getDomain = (props, axis) => {
  return victory_core__WEBPACK_IMPORTED_MODULE_3__.createDomainFunction(getDomainFromData)(props, axis);
};
const getLabelStyle = (props, styleObject, namespace) => {
  ...
  if (!victory_core__WEBPACK_IMPORTED_MODULE_4__.isTooltip(component)) {
    return baseStyle;
  }
  const tooltipTheme = props.theme && props.theme.tooltip || {};
  return lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, tooltipTheme.style, baseStyle);
};
const getStyles = function (props, style, defaultStyles) {
  ...
  const labelStyle = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, style.labels, defaultLabels);
  return {
    parent: lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, style.parent, defaultParent, {
      width,
      height
    }),
    labels: labelStyle,
    data: lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, style.data, defaultData),
    openLabels: lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, style.openLabels, getLabelStyle(props, defaultStyles, "open"), labelStyle),
    closeLabels: lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, style.closeLabels, getLabelStyle(props, defaultStyles, "close"), labelStyle),
    lowLabels: lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, style.lowLabels, getLabelStyle(props, defaultStyles, "low"), labelStyle),
    highLabels: lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, style.highLabels, getLabelStyle(props, defaultStyles, "high"), labelStyle)
  };
};
...
const formatDataFromDomain = (datum, domain) => {
  const minDomainX = victory_core__WEBPACK_IMPORTED_MODULE_5__.getMinValue(domain.x);
  const maxDomainX = victory_core__WEBPACK_IMPORTED_MODULE_5__.getMaxValue(domain.x);
  const minDomainY = victory_core__WEBPACK_IMPORTED_MODULE_5__.getMinValue(domain.y);
  const maxDomainY = victory_core__WEBPACK_IMPORTED_MODULE_5__.getMaxValue(domain.y);
  let {
    _x,
    _low,
    _open,
...
const getCalculatedValues = props => {
  ...
  const defaultStyle = victory_core__WEBPACK_IMPORTED_MODULE_4__.getDefaultStyles(props, "candlestick");
  ...
  const origin = polar ? props.origin || victory_core__WEBPACK_IMPORTED_MODULE_4__.getPolarOrigin(props) : undefined;
...
const getDataStyles = function (datum, style, props) {
  if (style === void 0) {
    style = {};
  }
  if (props.disableInlineStyles) {
...
const getCandleWidth = (props, style) => {
  ...
  if (candleWidth) {
    return victory_core__WEBPACK_IMPORTED_MODULE_4__.isFunction(candleWidth) ? victory_core__WEBPACK_IMPORTED_MODULE_4__.evaluateProp(candleWidth, props) : candleWidth;
  ...
  const defaultWidth = candleRatio * (data.length < 2 ? DEFAULT_CANDLE_WIDTH : extent / candles);
  return Math.max(1, defaultWidth);
};
const getOrientation = function (labelOrientation, type) {
  if (type === void 0) {
    type = "labels";
  }
...
const calculatePlotValues = props => {
  ...
  if (horizontal) {
    ...
    const dy = orientation === "top" || orientation === "bottom" ? signY * (candleWidth / 2) + signY * (labelStyle.padding || 0) : 0;
    const dx = orientation === "top" || orientation === "bottom" ? 0 : signX * (labelStyle.padding || 1);
    return {
      yValue,
      xValue,
      dx,
...
const getLabelProps = (props, text, style, type) => {
  ...
  const orientation = component.props && component.props.orientation || getOrientation(labelOrientation, type) || defaultOrientation;
  const positions = {
    high,
    low,
    open,
  ...
  return lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, labelProps, victory_core__WEBPACK_IMPORTED_MODULE_4__.omit(tooltipTheme, ["style"]));
};
/* eslint-enable max-params*/

const getBaseProps = (initialProps, fallbackProps) => {
  // eslint-disable-line max-statements
  const props = victory_core__WEBPACK_IMPORTED_MODULE_4__.modifyProps(initialProps, fallbackProps, "candlestick");
  ...
  return data.reduce((childProps, datum, index) => {
    const eventKey = !victory_core__WEBPACK_IMPORTED_MODULE_4__.isNil(datum.eventKey) ? datum.eventKey : index;
    ...
    const extendedProps = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()(Object.assign({}, dataProps), props);
    childProps[eventKey] = {
      data: dataProps
    };
    if (labels) {
      const text = victory_core__WEBPACK_IMPORTED_MODULE_7__.getText(props, formattedDatum, index);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VictoryCandlestick": function() { return /* binding */ VictoryCandlestick; }
/* harmony export */ });
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/default-transitions.js");
...
/* harmony import */ var _candle__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./candle */ "./candle.tsx");
 ...
 */
class VictoryCandlestickBase extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  static defaultTransitions = victory_core__WEBPACK_IMPORTED_MODULE_2__.discreteTransitions();
  static defaultProps = {
    containerComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_3__.VictoryContainer, null),
    data: defaultData,
    dataComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_candle__WEBPACK_IMPORTED_MODULE_4__.Candle, null),
    ...
    highLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_5__.VictoryLabel, null),
    lowLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_5__.VictoryLabel, null),
    openLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_5__.VictoryLabel, null),
    closeLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_5__.VictoryLabel, null),
    samples: 50,
    sortOrder: "ascending",
    standalone: true,
  ...
  static getDomain(props, axis) {
    return (0,_helper_methods__WEBPACK_IMPORTED_MODULE_7__.getDomain)(props, axis);
  }
  static getData(props) {
    return (0,_helper_methods__WEBPACK_IMPORTED_MODULE_7__.getData)(props);
  }
  ...
  shouldRenderDatum = datum => {
    return !victory_core__WEBPACK_IMPORTED_MODULE_1__.isNil(datum._x) && !victory_core__WEBPACK_IMPORTED_MODULE_1__.isNil(datum._high) && !victory_core__WEBPACK_IMPORTED_MODULE_1__.isNil(datum._low) && !victory_core__WEBPACK_IMPORTED_MODULE_1__.isNil(datum._close) && !victory_core__WEBPACK_IMPORTED_MODULE_1__.isNil(datum._open);
  };
  renderCandleData(props, shouldRenderDatum) {
    ...
    const labelComponents = types.flatMap(type => this.dataKeys.map((key, index) => {
      ...
      if (labelProps.text !== undefined && labelProps.text !== null) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(baseComponent, labelProps);
      }
      return undefined;
  ...
  render() {
    ...
    return victory_core__WEBPACK_IMPORTED_MODULE_8__.withSafeUserProps(component, props);
  }
}
const VictoryCandlestick = (0,victory_core__WEBPACK_IMPORTED_MODULE_9__.addEvents)(VictoryCandlestickBase, options);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Candle": function() { return /* reexport safe */ _candle__WEBPACK_IMPORTED_MODULE_1__.Candle; },
/* harmony export */   "VictoryCandlestick": function() { return /* reexport safe */ _victory_candlestick__WEBPACK_IMPORTED_MODULE_0__.VictoryCandlestick; }
/* harmony export */ });
/* harmony import */ var _victory_candlestick__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./victory-candlestick */ "./victory-candlestick.tsx");
/* harmony import */ var _candle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./candle */ "./candle.tsx");
